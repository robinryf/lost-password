...
namespace Stateless
{
    public partial class StateMachine<TState, TTrigger, TContext>
    {
        ...
        public partial class StateConfiguration
        {
            ...
            public StateConfiguration OnEntry(Action<TContext> entryAction, string entryActionDescription = null)
            {
	            return OnEntry(transition => entryAction(transition.Context), entryActionDescription);
            }
            ...
            public StateConfiguration OnExit(Action<TContext> exitAction, string exitActionDescription = null)
            {
	            return OnExit(transition => exitAction(transition.Context), exitActionDescription);
            }
