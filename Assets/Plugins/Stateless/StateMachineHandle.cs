...
namespace Stateless
{
	...
	public partial class StateMachine<TState, TTrigger, TContext>
	{
		...
		public class StateMachineHandle
		{
			...
			{
				Context = context;
				Context.CurrentState = _initialState;
				_machine = machine;
				_initialState = initialState;
				_machine.EnterState(_machine.GetRepresentation(_initialState),
					new InitialTransition(_initialState, _initialState, default, context), null);
			}
        ...
        StateRepresentation CurrentRepresentation
        {
            get
            {
                return _machine.GetRepresentation(Context.CurrentState);
            }
        }
        ...
        {
            var representativeState = _machine.GetRepresentation(Context.CurrentState);
